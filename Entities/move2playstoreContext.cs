...
namespace Api
{
    public partial class move2playstoreContext : DbContext
    {
        public move2playstoreContext()
        {
        }

        public move2playstoreContext(DbContextOptions<move2playstoreContext> options)
            : base(options)
        {
        }
